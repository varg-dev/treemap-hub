...
class TREEMAP_MEASUREMENTS_API AngularDisplacement
{
public:
    AngularDisplacement();
...
protected:
    float angularDisplacement(LinearizedTree * tree, const std::unordered_map<std::uint32_t, std::uint32_t> & nodeIndexById, const LinearizedBuffer<Rect> & layout,
